...
Reports can be as single comments for each violation:

![Gitea Single Comment](/pull-request-comment-single.png)

Or one comment with a summary of all violations:

![Gitea Summary Comment](/pull-request-comment-summary.png)
